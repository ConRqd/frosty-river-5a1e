...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-river-5a1e
```

A live public deployment of this template is available at [https://frosty-river-5a1e.templates.workers.dev](https://frosty-river-5a1e.templates.workers.dev)
